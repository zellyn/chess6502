...
// PeSTO tables, copied verbatim from cmd/gentables/pesto.go (which is
// the checked source of truth for the asm tables). Indexed as the C
// source: 0 = a8, 63 = h1. Values EXCLUDE piece base values.
